...
#ifndef __VCS_IMPORT_DPI_STUB_read_elf
#define __VCS_IMPORT_DPI_STUB_read_elf
__attribute__((weak)) void read_elf(/* INPUT */const char* A_1)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */const char* A_1) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(const char* A_1)) dlsym(RTLD_NEXT, "read_elf");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        _vcs_dpi_fp_(A_1);
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "read_elf");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_read_elf */

#ifndef __VCS_IMPORT_DPI_STUB_get_section
#define __VCS_IMPORT_DPI_STUB_get_section
__attribute__((weak)) char get_section(/* OUTPUT */long long *A_1, /* OUTPUT */long long *A_2)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static char (*_vcs_dpi_fp_)(/* OUTPUT */long long *A_1, /* OUTPUT */long long *A_2) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (char (*)(long long* A_1, long long* A_2)) dlsym(RTLD_NEXT, "get_section");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        return _vcs_dpi_fp_(A_1, A_2);
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "get_section");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_get_section */

#ifndef __VCS_IMPORT_DPI_STUB_read_section_sv
#define __VCS_IMPORT_DPI_STUB_read_section_sv
__attribute__((weak)) void read_section_sv(/* INPUT */long long A_1, const /* INOUT */svOpenArrayHandle A_2)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */long long A_1, const /* INOUT */svOpenArrayHandle A_2) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(long long A_1, const svOpenArrayHandle A_2)) dlsym(RTLD_NEXT, "read_section_sv");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "read_section_sv");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_read_section_sv */
...
#ifndef __VCS_IMPORT_DPI_STUB_read_symbol
#define __VCS_IMPORT_DPI_STUB_read_symbol
__attribute__((weak)) char read_symbol(/* INPUT */const char* A_1, /* INOUT */unsigned long long *A_2)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static char (*_vcs_dpi_fp_)(/* INPUT */const char* A_1, /* INOUT */unsigned long long *A_2) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (char (*)(const char* A_1, unsigned long long* A_2)) dlsym(RTLD_NEXT, "read_symbol");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
        return _vcs_dpi_fp_(A_1, A_2);
        ...
        int lineNumber;
        svGetCallerInfo(&fileName, &lineNumber);
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "read_symbol");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_read_symbol */
...
__attribute__((weak)) int jtag_tick(/* OUTPUT */unsigned char *A_1, /* OUTPUT */unsigned char *A_2, /* OUTPUT */unsigned char *A_3, /* OUTPUT */unsigned char *A_4, /* INPUT */unsigned char A_5)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static int (*_vcs_dpi_fp_)(/* OUTPUT */unsigned char *A_1, /* OUTPUT */unsigned char *A_2, /* OUTPUT */unsigned char *A_3, /* OUTPUT */unsigned char *A_4, /* INPUT */unsigned char A_5) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (int (*)(unsigned char* A_1, unsigned char* A_2, unsigned char* A_3, unsigned char* A_4, unsigned char A_5)) dlsym(RTLD_NEXT, "jtag_tick");
        _vcs_dpi_stub_initialized_ = 1;
    }
    if (_vcs_dpi_fp_) {
